...
trial_info = stim.generate_trial(analysis = False,num_fixed=0,var_delay=True,var_resp_delay=True,var_num_pulses=par['var_num_pulses'])
plt.figure()
print(trial_info['neural_input'][0].shape)
